...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_GUN, MOVE_CONFUSE_RAY, MOVE_ROOST},
    ...
    .moves = {MOVE_WATER_GUN, MOVE_SCRATCH, MOVE_BITE, MOVE_LICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 10,
    .species = SPECIES_STARAVIA,
    .moves = {MOVE_GUST, MOVE_QUICK_ATTACK, MOVE_DEFOG, MOVE_WHIRLWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 11,
    ...
    .moves = {MOVE_AQUA_JET, MOVE_BITE, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMon sParty_GruntMtPyre3[] = {
    ...
    .moves = {MOVE_WILL_O_WISP, MOVE_DESTINY_BOND, MOVE_ALLY_SWITCH, MOVE_HEX},
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_SNARL, MOVE_CHARM, MOVE_SCREECH},
    .heldItem = ITEM_SABLENITE,
    ...
    .moves = {MOVE_HEADBUTT, MOVE_BRICK_BREAK, MOVE_PAYBACK, MOVE_FACADE},
...
static const struct TrainerMon sParty_GruntWeatherInst4[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_CONFUSE_RAY, MOVE_RECOVER, MOVE_DARK_PULSE},
    .heldItem = ITEM_SABLENITE,
    .ability = ABILITY_PRANKSTER
    },
    {
    ...
    .moves = {MOVE_HELPING_HAND, MOVE_WISH, MOVE_YAWN, MOVE_FOUL_PLAY},
    ...
    .moves = {MOVE_PAIN_SPLIT, MOVE_WILL_O_WISP, MOVE_NIGHT_SHADE, MOVE_SUBSTITUTE},
...
static const struct TrainerMon sParty_ShellyWeatherInstitute[] = {
    ...
    .moves = {MOVE_CHILLING_WATER, MOVE_AQUA_JET, MOVE_DESTINY_BOND, MOVE_TOXIC_SPIKES}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 31,
    ...
    .moves = {MOVE_NUZZLE, MOVE_FAKE_OUT, MOVE_VOLT_SWITCH, MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 32,
    ...
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_THUNDER_FANG, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 33,
    ...
    .ability = ABILITY_SWIFT_SWIM,
    .moves = {MOVE_AQUA_JET, MOVE_WATERFALL, MOVE_HEADBUTT, MOVE_ICE_SPINNER}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 32,
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_FAKE_OUT, MOVE_FEINT, MOVE_ICE_SHARD, MOVE_LOW_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 46,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_TAILWIND, MOVE_FOUL_PLAY, MOVE_HAZE, MOVE_QUASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH, MOVE_KNOCK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    ...
    .moves = {MOVE_ANCIENT_POWER, MOVE_HEAT_WAVE, MOVE_AIR_SLASH, MOVE_ROOST}
    }
};
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_INFERNAL_PARADE, MOVE_FLAMETHROWER, MOVE_SUNNY_DAY, MOVE_ERUPTION}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LAST_RESPECTS, MOVE_ROAR, MOVE_CRUNCH, MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 51,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM, MOVE_FOCUS_BLAST, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KINGS_SHIELD, MOVE_CLOSE_COMBAT, MOVE_SHADOW_BALL, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    ...
    .moves = {MOVE_TORCH_SONG, MOVE_SHADOW_BALL, MOVE_SNARL, MOVE_EARTH_POWER}
    }
};
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .moves = {MOVE_WOOD_HAMMER, MOVE_BLIZZARD, MOVE_GRASS_KNOT, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .moves = {MOVE_ICICLE_CRASH, MOVE_HAMMER_ARM, MOVE_ROCK_SLIDE, MOVE_BULLDOZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 52,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_EARTHQUAKE, MOVE_ICE_SHARD, MOVE_ICICLE_CRASH, MOVE_BODY_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    ...
    .moves = {MOVE_ICY_WIND, MOVE_BLIZZARD, MOVE_ROOST, MOVE_SNOWSCAPE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    ...
    .moves = {MOVE_DRAGON_DANCE, MOVE_ICICLE_SPEAR, MOVE_BREAKING_SWIPE, MOVE_GLAIVE_RUSH}
    }
};
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MAGMA_STORM, MOVE_EARTH_POWER, MOVE_LAVA_PLUME, MOVE_IRON_HEAD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    ...
    .moves = {MOVE_EXTREME_SPEED, MOVE_OUTRAGE, MOVE_WATERFALL, MOVE_BODY_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .moves = {MOVE_BRICK_BREAK, MOVE_HARDEN, MOVE_BODY_SLAM, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 16,
    ...
    .moves = {MOVE_SHELL_SMASH, MOVE_WATER_PULSE, MOVE_ANCIENT_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 17,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_X_SCISSOR, MOVE_AQUA_JET, MOVE_SWORDS_DANCE, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_KICK, MOVE_SEISMIC_TOSS, MOVE_BULK_UP, MOVE_KNOCK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 18,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_LOW_KICK, MOVE_HEADBUTT, MOVE_PAYBACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_MACH_PUNCH, MOVE_FORCE_PALM, MOVE_DOUBLE_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
    ...
    .heldItem = ITEM_NORMAL_GEM,
    .moves = {MOVE_FAKE_OUT, MOVE_DETECT, MOVE_FORCE_PALM, MOVE_POWER_UP_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 20,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ASSURANCE, MOVE_WORK_UP, MOVE_FLAME_CHARGE, MOVE_HEADBUTT}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 22,
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_SWORDS_DANCE, MOVE_ROCK_TOMB, MOVE_DRAIN_PUNCH}
    },
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_LOW_KICK, MOVE_QUICK_ATTACK, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 20,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPING_HAND, MOVE_REVIVAL_BLESSING, MOVE_THUNDERSHOCK, MOVE_ARM_THRUST}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 24,
    ...
    .moves = {MOVE_SPARK, MOVE_QUICK_ATTACK, MOVE_FLAME_CHARGE, MOVE_VOLT_SWITCH}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .moves = {MOVE_EXTRASENSORY, MOVE_OVERHEAT, MOVE_WILL_O_WISP, MOVE_WEATHER_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 28,
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_OVERHEAT, MOVE_ROCK_SLIDE, MOVE_CLEAR_SMOG, MOVE_YAWN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 28,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .ability = ABILITY_DROUGHT,
    .moves = {MOVE_OVERHEAT, MOVE_BODY_SLAM, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 31,
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BODY_SLAM, MOVE_FACADE, MOVE_ENCORE, MOVE_THROAT_CHOP}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 29,
    ...
    .moves = {MOVE_OBSTRUCT, MOVE_FACADE, MOVE_KNOCK_OFF, MOVE_REVENGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 32,
    ...
    .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_FACADE, MOVE_ROLLOUT}
    },
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENDEAVOR, MOVE_QUICK_ATTACK, MOVE_WHIRLWIND, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 30,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_ROCK_BLAST, MOVE_ICY_WIND, MOVE_HELPING_HAND, MOVE_BULLDOZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 32,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PARTING_SHOT, MOVE_ROCK_SLIDE, MOVE_ACROBATICS, MOVE_FEATHER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 33,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TAILWIND, MOVE_ROOST, MOVE_FLY, MOVE_NIGHT_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .moves = {MOVE_HEAT_WAVE, MOVE_HURRICANE, MOVE_ROOST, MOVE_U_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 32,
    ...
    .moves = {MOVE_NUZZLE, MOVE_LIGHT_SCREEN, MOVE_ENCORE, MOVE_ELECTROWEB}
    },
};
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_WEAKNESS_POLICY,
    .moves = {MOVE_AURA_SPHERE, MOVE_EXPANDING_FORCE, MOVE_ARMOR_CANNON, MOVE_PSYCHIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 41,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WISH, MOVE_DAZZLING_GLEAM, MOVE_ENCORE, MOVE_PERISH_SONG}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 42,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_SHELL_SMASH, MOVE_GIGA_DRAIN, MOVE_STORED_POWER, MOVE_SHADOW_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 42,
...
static const struct TrainerMon sParty_Wallace[] = {
    ...
    .heldItem = ITEM_DAMP_ROCK,
    .ability = ABILITY_DRIZZLE,
    .moves = {MOVE_RAIN_DANCE, MOVE_EARTH_POWER, MOVE_SCALD, MOVE_ENCORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
    ...
    .moves = {MOVE_SPORE, MOVE_RAGE_POWDER, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    ...
    .moves = {MOVE_WATERFALL, MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_FLIP_TURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 56,
    ...
    .moves = {MOVE_HURRICANE, MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURGING_STRIKES, MOVE_CLOSE_COMBAT, MOVE_SUCKER_PUNCH, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .moves = {MOVE_PERISH_SONG, MOVE_FREEZE_DRY, MOVE_PROTECT, MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 44,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_REST, MOVE_SUBSTITUTE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 44,
    ...
    .heldItem = ITEM_EVIOLITE,
    .ability = ABILITY_SHADOW_TAG,
    .moves = {MOVE_FAKE_OUT, MOVE_ALLY_SWITCH, MOVE_SUBSTITUTE, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 47,
    ...
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_PERISH_SONG, MOVE_POLTERGEIST, MOVE_PROTECT, MOVE_FLARE_BLITZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 47,
    ...
    .moves = {MOVE_AIR_SLASH, MOVE_FOLLOW_ME, MOVE_PROTECT, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMon sParty_Cristian[] = {
    ...
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BELLY_DRUM, MOVE_DRAIN_PUNCH}
    }
};
...
static const struct TrainerMon sParty_TabithaMtChimney[] = {
    ...
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 6, 16),
    .lvl = 24,
    .species = SPECIES_RAPIDASH,
    },
    {
...
static const struct TrainerMon sParty_MaxieMagmaHideout[] = {
    ...
    .ability = ABILITY_DROUGHT,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_CLEAR_SMOG, MOVE_LAVA_PLUME, MOVE_IRON_DEFENSE, MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    .species = SPECIES_ROTOM_HEAT,
    .moves = {MOVE_SUNNY_DAY, MOVE_THUNDER_WAVE, MOVE_HEX, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 39,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_SUNNY_DAY, MOVE_ERUPTION, MOVE_EARTH_POWER, MOVE_YAWN}
    },
        {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    .species = SPECIES_TURTONATOR,
    .moves = {MOVE_SUNNY_DAY, MOVE_SHELL_TRAP, MOVE_DRAGON_PULSE, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 39,
    ...
    .moves = {MOVE_ENERGY_BALL, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_ENCORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 40,
...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .lvl = 4,
    .species = SPECIES_ARON,
    .moves = {MOVE_ENDEAVOR, MOVE_HEADBUTT, MOVE_METAL_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 6,
    .species = SPECIES_SHROOMISH,
    .heldItem = ITEM_TOXIC_ORB,
    .moves = {MOVE_SUBSTITUTE, MOVE_SLEEP_POWDER, MOVE_TACKLE, MOVE_ABSORB}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 7,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_HEADBUTT, MOVE_BITE, MOVE_DIG, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMon sParty_BrendanLilycoveMudkip[] = {
    ...
    .lvl = 34,
    .species = SPECIES_RAICHU,
    .moves = {MOVE_NUZZLE, MOVE_FAKE_OUT, MOVE_VOLT_SWITCH, MOVE_ELECTRO_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    .species = SPECIES_VAPOREON,
    .moves = {MOVE_WISH, MOVE_BATON_PASS, MOVE_WATER_PULSE, MOVE_AURORA_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    .species = SPECIES_DARMANITAN,
    .moves = {MOVE_FIRE_PUNCH, MOVE_HAMMER_ARM, MOVE_HEADBUTT, MOVE_ROCK_SLIDE},
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_GROWTH, MOVE_STRENGTH_SAP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    .species = SPECIES_DELPHOX,
    .moves = {MOVE_MYSTICAL_FIRE, MOVE_HYPNOSIS, MOVE_WILL_O_WISP, MOVE_SHADOW_BALL},
    ...
    .moves = {MOVE_LEAF_BLADE, MOVE_X_SCISSOR, MOVE_ENDEAVOR, MOVE_DRAGON_DANCE}
    }
};
...
static const struct TrainerMon sParty_BrendanLilycoveTreecko[] = {
    ...
    .moves = {MOVE_WATER_SHURIKEN, MOVE_AQUA_JET, MOVE_SHADOW_SNEAK, MOVE_EXTRASENSORY},
    ...
    .moves = {MOVE_BLAZE_KICK, MOVE_BULK_UP, MOVE_QUICK_ATTACK, MOVE_LOW_KICK},
...
static const struct TrainerMon sParty_BrendanLilycoveTorchic[] = {
    ...
    .moves = {MOVE_SPIKY_SHIELD, MOVE_SEED_BOMB, MOVE_CURSE, MOVE_BODY_SLAM},
    .ability = ABILITY_PROTEAN
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_SWAMPERTITE,
    .moves = {MOVE_SURF, MOVE_EARTHQUAKE, MOVE_FLIP_TURN, MOVE_LIQUIDATION},
...
static const struct TrainerMon sParty_StenBattleOne[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 3,
    .species = SPECIES_SLOWPOKE,
...
static const struct TrainerMon sParty_MatsBattleTwo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_CONFUSE_RAY, MOVE_AIR_SLASH, MOVE_HAZE, MOVE_SCREECH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 25,
    ...
    .moves = {MOVE_SNARL, MOVE_BODY_SLAM, MOVE_DRAGON_BREATH, MOVE_WORK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 25,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_ANCIENT_POWER, MOVE_CHILLING_WATER, MOVE_CLEAR_SMOG, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 27,
    .heldItem = ITEM_CHARCOAL,
    .species = SPECIES_CHARMELEON,
    .moves = {MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_THUNDER_PUNCH, MOVE_FLAME_CHARGE}
    }
};
...
static const struct TrainerMon sParty_MatsBattleThree[] = {
    ...
    .lvl = 32,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_CONFUSE_RAY, MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_CROSS_POISON}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .lvl = 31,
    .species = SPECIES_DEINO,
    .moves = {MOVE_SNARL, MOVE_CRUNCH, MOVE_DRAGON_PULSE, MOVE_WORK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .ability = ABILITY_STORM_DRAIN,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_YAWN, MOVE_CHILLING_WATER, MOVE_ICE_BEAM, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
...
static const struct TrainerMon sParty_MatsBattleFour[] = {
    ...
    .lvl = 34,
    .species = SPECIES_DEINO,
    .moves = {MOVE_SNARL, MOVE_DARK_PULSE, MOVE_DRAGON_PULSE, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .moves = {MOVE_SOLAR_BEAM, MOVE_HEAT_WAVE, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMon sParty_MatsBattleFive[] = {
    ...
    .lvl = 60,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_ROOST, MOVE_U_TURN, MOVE_SUPER_FANG, MOVE_BRAVE_BIRD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
...
static const struct TrainerMon sParty_JensBattleOne[] = {
    ...
    .moves = {MOVE_U_TURN, MOVE_X_SCISSOR, MOVE_AERIAL_ACE, MOVE_QUICK_ATTACK},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
    ...
    .moves = {MOVE_SHELL_SMASH, MOVE_WATERFALL, MOVE_FLIP_TURN, MOVE_FACADE},
    }
    ,
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    ...
    .moves = {MOVE_YAWN, MOVE_MUDDY_WATER, MOVE_CURSE, MOVE_RECOVER},
    }
    ,
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
...
static const struct TrainerMon sParty_JensRoute203_One[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    .species = SPECIES_LANDORUS_THERIAN,
...
static const struct TrainerMon sParty_RocketF_One_RockethideoutF1[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    .species = SPECIES_TOXICROAK,
    ...
    .moves = {MOVE_DRAIN_PUNCH, MOVE_POISON_JAB, MOVE_ICE_PUNCH, MOVE_BULLET_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .moves = {MOVE_IRON_HEAD, MOVE_TAUNT, MOVE_X_SCISSOR, MOVE_CLOSE_COMBAT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_FLASH_CANNON, MOVE_SHADOW_BALL},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_DRAGON_DANCE, MOVE_KNOCK_OFF, MOVE_POISON_JAB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_STICKY_WEB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_IRON_DEFENSE, MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_RECOVER},
    }
};
...
static const struct TrainerMon sParty_RocketF_Two_RockethideoutF1[] = {
    ...
    .moves = {MOVE_YAWN, MOVE_SHELL_SIDE_ARM, MOVE_SLACK_OFF, MOVE_SURF},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    ...
    .moves = {MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_BELCH, MOVE_SHADOW_BALL},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_HEAT_ROCK,
    .ability = ABILITY_DROUGHT,
    .moves = {MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_HEAT_WAVE, MOVE_FLAMETHROWER},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_LOADED_DICE,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB, MOVE_BULLET_PUNCH, MOVE_LEAF_STORM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .moves = {MOVE_ROOST, MOVE_TAILWIND, MOVE_BRAVE_BIRD, MOVE_U_TURN},
    }
};
...
static const struct TrainerMon sParty_RocketM_Three_RockethideoutF1[] = {
    ...
    .moves = {MOVE_ARMOR_CANNON, MOVE_PROTECT, MOVE_EXPANDING_FORCE, MOVE_STORED_POWER},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_CLEAR_AMULET,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_IRON_HEAD, MOVE_PROTECT, MOVE_DRAGON_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .moves = {MOVE_FOLLOW_ME, MOVE_BEAT_UP, MOVE_TAUNT, MOVE_POPULATION_BOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BRAVE_BIRD, MOVE_DETECT, MOVE_THROAT_CHOP},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 68,
    ...
    .moves = {MOVE_FLIP_TURN, MOVE_WAVE_CRASH, MOVE_JET_PUNCH, MOVE_ICE_PUNCH},
    }
};
...
static const struct TrainerMon sParty_RocketM_Four_RockethideoutF1[] = {
    ...
    .moves = {MOVE_MAKE_IT_RAIN, MOVE_SHADOW_BALL, MOVE_POWER_GEM, MOVE_FOCUS_BLAST},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_SAFETY_GOGGLES,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_WAVE_CRASH, MOVE_AQUA_JET, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
...
static const struct TrainerMon sParty_RocketF_Five_RockethideoutF1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_DISCHARGE, MOVE_U_TURN, MOVE_STEALTH_ROCK, MOVE_ROCK_SLIDE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    .species = SPECIES_GASTRODON,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_MUDDY_WATER, MOVE_SCALD, MOVE_RECOVER, MOVE_TOXIC},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    ...
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_GRASS_KNOT, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .heldItem = ITEM_EVIOLITE,
    .ability = ABILITY_LIGHTNING_ROD,
    .moves = {MOVE_HORN_DRILL, MOVE_MEGAHORN, MOVE_HAMMER_ARM, MOVE_STOMPING_TANTRUM},
    }
};
...
static const struct TrainerMon sParty_RocketScientist_One_RockethideoutF1[] = {
    ...
    .heldItem = ITEM_LIGHT_CLAY,
    .ability = ABILITY_PRANKSTER,
    .moves = {MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_THUNDER_WAVE, MOVE_IRON_HEAD},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .moves = {MOVE_IRON_HEAD, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_SKITTER_SMACK, MOVE_CLOSE_COMBAT, MOVE_SLUDGE_BOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_GIGATON_HAMMER, MOVE_ENCORE, MOVE_PLAY_ROUGH},
    },
};
...
static const struct TrainerMon sParty_RocketScientist_Two_RockethideoutF1[] = {
    ...
    .species = SPECIES_CHESNAUGHT,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_SPIKY_SHIELD, MOVE_SEED_BOMB, MOVE_BRICK_BREAK, MOVE_BODY_SLAM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
...
static const struct TrainerMon sParty_RocketLeader_DewfordGym[] = { 
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    .species = SPECIES_GYARADOS,
    .ability = ABILITY_INTIMIDATE,
    .heldItem = ITEM_COVERT_CLOAK,
    .moves = {MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_PROTECT, MOVE_BOUNCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .moves = {MOVE_WIDE_GUARD, MOVE_FAKE_OUT, MOVE_U_TURN, MOVE_CLOSE_COMBAT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_BULLDOZE, MOVE_IRON_HEAD, MOVE_ROCK_TOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .heldItem = ITEM_CHOICE_SPECS,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SNARL, MOVE_DARK_PULSE, MOVE_EARTH_POWER, MOVE_DRACO_METEOR},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_REGENERATOR,
    .moves = {MOVE_POLLEN_PUFF, MOVE_RAGE_POWDER, MOVE_CLEAR_SMOG, MOVE_SLEEP_POWDER},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .moves = {MOVE_ARMOR_CANNON, MOVE_PSYCHIC, MOVE_ENERGY_BALL, MOVE_EXPANDING_FORCE},
    }
};
static const struct TrainerMon sParty_RocketOne_DewfordGym[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_FLAME_ORB,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_CROSS_CHOP, MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    ...
    .moves = {MOVE_FLYING_PRESS, MOVE_CLOSE_COMBAT, MOVE_BRAVE_BIRD, MOVE_ROCK_SLIDE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    ...
    .heldItem = ITEM_FLAME_ORB,
    .ability = ABILITY_GUTS,
    .moves = {MOVE_OBSTRUCT, MOVE_FACADE, MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_DEFIANT,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_BODY_SLAM, MOVE_U_TURN},
    }
};
static const struct TrainerMon sParty_RocketTwo_DewfordGym[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    .species = SPECIES_LIEPARD,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_PARTING_SHOT, MOVE_KNOCK_OFF, MOVE_FLARE_BLITZ, MOVE_FAKE_OUT},
    }
};
static const struct TrainerMon sParty_RocketLeader_RustboroGym[] = {
    ...
    .moves = {MOVE_METEOR_BEAM, MOVE_MORTAL_SPIN, MOVE_EARTH_POWER, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 71,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .ability = ABILITY_QUARK_DRIVE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_WILD_CHARGE, MOVE_LOW_KICK, MOVE_THUNDER_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 71,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_OVERHEAT, MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_VOLT_SWITCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 71,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_SAND_STREAM,
    .moves = {MOVE_ASSURANCE, MOVE_ROCK_SLIDE, MOVE_DRAGON_TAIL, MOVE_ICE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 71,
    ...
    .heldItem = ITEM_COVERT_CLOAK,
    .ability = ABILITY_FLASH_FIRE,
    .moves = {MOVE_LEECH_SEED, MOVE_SUBSTITUTE, MOVE_PROTECT, MOVE_DRAIN_PUNCH},
    }
};
static const struct TrainerMon sParty_RocketOne_RustboroGym[] = {
    ...
    .moves = {MOVE_HEAVY_SLAM, MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .ability = ABILITY_TOUGH_CLAWS,
    .moves = {MOVE_ACCELEROCK, MOVE_CLOSE_COMBAT, MOVE_ROCK_SLIDE, MOVE_PSYCHIC_FANGS},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 70,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_ICE_SHARD, MOVE_ENDEAVOR, MOVE_STEALTH_ROCK, MOVE_PLAY_ROUGH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
    ...
    .heldItem = ITEM_POWER_HERB,
    .moves = {MOVE_GRAVITY, MOVE_METEOR_BEAM, MOVE_HYPER_BEAM, MOVE_EARTH_POWER}
    },
};
static const struct TrainerMon sParty_RocketTwo_RustboroGym[] = {
    ...
    .moves = {MOVE_GUNK_SHOT, MOVE_BODY_SLAM, MOVE_TOXIC, MOVE_TOXIC_SPIKES},
    }
    ,{
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 69,
...
static const struct TrainerMon sParty_RocketLeader_MauvilleGym[] = {
    ...
    .heldItem = ITEM_BOOSTER_ENERGY,
    .moves = {MOVE_FAKE_OUT, MOVE_VOLT_SWITCH, MOVE_WILD_CHARGE, MOVE_CLOSE_COMBAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .moves = {MOVE_HYPER_VOICE, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 72,
    ...
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_FOLLOW_ME, MOVE_THUNDER_PUNCH, MOVE_BRICK_BREAK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .moves = {MOVE_WILD_CHARGE, MOVE_CRUNCH, MOVE_VOLT_SWITCH, MOVE_FLAMETHROWER}
    }
};
static const struct TrainerMon sParty_RocketOne_MauvilleGym[] = {
    ...
    .heldItem = ITEM_EVIOLITE,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_TRICK_ROOM, MOVE_STOMPING_TANTRUM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_DISCHARGE, MOVE_PROTECT, MOVE_MUDDY_WATER},
    }
};
static const struct TrainerMon sParty_RocketTwo_MauvilleGym[] = {
    ...
    .moves = {MOVE_EXPLOSION, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM, MOVE_FIRE_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDERBOLT, MOVE_DISCHARGE, MOVE_CONFUSE_RAY},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .heldItem = ITEM_CHOICE_SPECS,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDERBOLT, MOVE_BLIZZARD},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDERBOLT, MOVE_HYDRO_PUMP, MOVE_THUNDER_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
...
static const struct TrainerMon sParty_RocketLeader_PetalburgGym[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_FAKE_OUT, MOVE_KNOCK_OFF, MOVE_U_TURN, MOVE_TAUNT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .moves = {MOVE_GIGA_IMPACT, MOVE_HYPER_BEAM, MOVE_ENCORE, MOVE_PLAY_ROUGH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .ability = ABILITY_CUTE_CHARM,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_FIRE_PUNCH, MOVE_TEETER_DANCE,MOVE_THUNDER_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .moves = {MOVE_TRI_ATTACK, MOVE_THUNDERBOLT, MOVE_DARK_PULSE, MOVE_ICE_BEAM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 72,
    ...
    .moves = {MOVE_DRAINING_KISS, MOVE_MOONBLAST, MOVE_CALM_MIND, MOVE_RECOVER},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 73,
    ...
    .heldItem = ITEM_BOOSTER_ENERGY,
    .ability = ABILITY_QUARK_DRIVE,
    .moves = {MOVE_MOONBLAST, MOVE_THUNDERBOLT, MOVE_CLOSE_COMBAT, MOVE_PSYSHOCK},
    },
};
static const struct TrainerMon sParty_RocketLeader_LavaridgeGym[] = {
    ...
    .heldItem = ITEM_POWER_HERB,
    .ability = ABILITY_QUARK_DRIVE,
    .moves = {MOVE_METEOR_BEAM, MOVE_BUG_BUZZ, MOVE_HEAT_WAVE, MOVE_AIR_SLASH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_SNARL, MOVE_EARTH_POWER, MOVE_HEAT_WAVE, MOVE_DRACO_METEOR},
    },
};
static const struct TrainerMon sParty_RocketOne_LavaridgeGym[] = {
    ...
    .moves = {MOVE_CLOSE_COMBAT, MOVE_RAGING_FURY, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 73,
    ...
    .heldItem = ITEM_CHARCOAL,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_ERUPTION, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_SHADOW_BALL},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 73,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_DRAGON_DANCE, MOVE_ICE_PUNCH, MOVE_WATERFALL, MOVE_DRAGON_CLAW},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 73,
    .species = SPECIES_SALAZZLE,
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_TOXIC, MOVE_FLAMETHROWER, MOVE_KNOCK_OFF, MOVE_DRAGON_PULSE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 73,
    ...
    .moves = {MOVE_HORN_LEECH, MOVE_MILK_DRINK, MOVE_EARTHQUAKE, MOVE_WILD_CHARGE},
    },
...
static const struct TrainerMon sParty_RocketTwo_LavaridgeGym[] = {
    ...
    .heldItem = ITEM_WEAKNESS_POLICY,
    .moves = {MOVE_FLAMETHROWER, MOVE_EARTHQUAKE, MOVE_IRON_HEAD, MOVE_STONE_EDGE},
    },
};
static const struct TrainerMon sParty_RocketLeader_FortreeGym[] = {
    ...
    .ability = ABILITY_PRANKSTER,
    .moves = {MOVE_ELECTRIC_TERRAIN, MOVE_RAIN_DANCE, MOVE_THUNDER_WAVE, MOVE_WILDBOLT_STORM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_WOOD_HAMMER, MOVE_ACROBATICS, MOVE_GRASSY_GLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    .species = SPECIES_IRON_HANDS,
    .heldItem = ITEM_BOOSTER_ENERGY,
    .moves = {MOVE_FAKE_OUT, MOVE_VOLT_SWITCH, MOVE_WILD_CHARGE, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_BOOSTER_ENERGY,
    .moves = {MOVE_PSYBLADE, MOVE_SWORDS_DANCE, MOVE_CLOSE_COMBAT, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
...
static const struct TrainerMon sParty_RocketLeader_MossdeepGym[] = {
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SWORDS_DANCE, MOVE_SACRED_SWORD, MOVE_LEAF_BLADE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_PLAY_ROUGH, MOVE_PSYCHIC, MOVE_VOLT_SWITCH, MOVE_EERIE_IMPULSE}
    },
};
static const struct TrainerMon sParty_RocketOne_MossdeepGym[] = {
    ...
    .ability = ABILITY_PRANKSTER,
    .heldItem = ITEM_BLACK_SLUDGE,
    .moves = {MOVE_KNOCK_OFF, MOVE_SUPER_FANG, MOVE_PARTING_SHOT, MOVE_GUNK_SHOT}
    },   
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 74,
    ...
    .moves = {MOVE_SPIKES, MOVE_U_TURN, MOVE_FLOWER_TRICK, MOVE_KNOCK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 74,
    ...
    .heldItem = ITEM_HEAVY_DUTY_BOOTS,
    .moves = {MOVE_MACH_PUNCH, MOVE_REVIVAL_BLESSING, MOVE_THUNDER_PUNCH, MOVE_VOLT_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_CLEAR_AMULET,
    .ability = ABILITY_MOXIE,
    .moves = {MOVE_AQUA_STEP, MOVE_AQUA_JET, MOVE_CLOSE_COMBAT, MOVE_SWORDS_DANCE}
    }
};
static const struct TrainerMon sParty_RocketLeader_SootopolisGym[] = {
    ...
    .heldItem = ITEM_POWER_HERB,
    .ability = ABILITY_QUARK_DRIVE,
    .moves = {MOVE_METEOR_BEAM, MOVE_DARK_PULSE, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_QUARK_DRIVE,
    .moves = {MOVE_ICY_WIND, MOVE_HYDRO_PUMP, MOVE_FREEZE_DRY, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .ability = ABILITY_STATIC,
    .moves = {MOVE_DISCHARGE, MOVE_DRAGON_PULSE, MOVE_DAZZLING_GLEAM, MOVE_VOLT_SWITCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    ...
    .heldItem = ITEM_WEAKNESS_POLICY,
    .ability = ABILITY_QUARK_DRIVE,
    .moves = {MOVE_KNOCK_OFF, MOVE_MEGAHORN, MOVE_IRON_HEAD, MOVE_RAPID_SPIN},
    }
};
...
static const struct TrainerMon sParty_RocketHideoutB1_One[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_INNER_FOCUS,
    .moves = {MOVE_BRAVE_BIRD, MOVE_CROSS_POISON, MOVE_X_SCISSOR, MOVE_DEFOG},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_FAKE_OUT, MOVE_SNARL, MOVE_PLAY_ROUGH, MOVE_FOUL_PLAY},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_BLACK_SLUDGE,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_SUCKER_PUNCH, MOVE_EXPLOSION, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_BODY_PRESS, MOVE_CLOSE_COMBAT, MOVE_EARTHQUAKE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
...
static const struct TrainerMon sParty_RocketHideoutB1_Three[] = {
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_FEATHER_DANCE, MOVE_REVELATION_DANCE, MOVE_QUIVER_DANCE, MOVE_HURRICANE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
...
static const struct TrainerMon sParty_RocketHideoutB1_Four[] = {
    ...
    .moves = {MOVE_BODY_PRESS, MOVE_STEALTH_ROCK, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_CALM_MIND, MOVE_MATCHA_GOTCHA, MOVE_STRENGTH_SAP, MOVE_SHADOW_BALL},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_DEFIANT,
    .moves = {MOVE_HYDRO_PUMP, MOVE_AQUA_JET, MOVE_ICE_BEAM, MOVE_GRASS_KNOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_DRAGON_DARTS, MOVE_U_TURN, MOVE_PHANTOM_FORCE, MOVE_SUCKER_PUNCH},
    },
};
static const struct TrainerMon sParty_RocketHideoutB1_Five[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_SHEER_FORCE,
    .moves = {MOVE_EARTH_POWER, MOVE_FIRE_BLAST, MOVE_SURF, MOVE_SLUDGE_BOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    .species = SPECIES_SCEPTILE,
    .heldItem = ITEM_SCEPTILITE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_X_SCISSOR, MOVE_ENDEAVOR, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .ability = ABILITY_ROCK_HEAD,
    .moves = {MOVE_HEAD_SMASH, MOVE_OUTRAGE, MOVE_CLOSE_COMBAT, MOVE_SCALE_SHOT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_HEAT_WAVE, MOVE_EARTHQUAKE, MOVE_STONE_EDGE},
    },
};
static const struct TrainerMon sParty_RocketHideoutB1_Six[] = {
    ...
    .heldItem = ITEM_CHARCOAL,
    .ability = ABILITY_DROUGHT,
    .moves = {MOVE_HEAT_WAVE, MOVE_ERUPTION, MOVE_SOLAR_BEAM, MOVE_CLEAR_SMOG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_CHLOROPHYLL,
    .moves = {MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_PROTECT, MOVE_SLEEP_POWDER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_ROCK_SLIDE, MOVE_U_TURN, MOVE_STEALTH_ROCK, MOVE_SWORDS_DANCE},
    },
    {    
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_HEAT_WAVE, MOVE_AIR_SLASH, MOVE_SOLARBEAM, MOVE_ANCIENT_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_MEGAHORN, MOVE_CEASELESS_EDGE, MOVE_SACRED_SWORD, MOVE_AQUA_JET},
    }
};
static const struct TrainerMon sParty_RocketHideoutB1_Giovanni_One[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    .species = SPECIES_ELECTABUZZ,
    .heldItem = ITEM_EVIOLITE,
    .ability = ABILITY_STATIC,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERPUNCH, MOVE_FIRE_PUNCH, MOVE_KNOCK_OFF},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_EFFECT_SPORE,
    .moves = {MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_DAZZLING_GLEAM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_SPITE, MOVE_WILL_O_WISP, MOVE_SUBSTITUTE, MOVE_HEX},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_HYPNOSIS},
    },
};
static const struct TrainerMon sParty_RocketHideoutB1_Giovanni_Two[] = {
       {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    .species = SPECIES_GARBODOR,
    .heldItem = ITEM_ROCKY_HELMET,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_EXPLOSION, MOVE_GUNK_SHOT, MOVE_DRAIN_PUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_STRENGTH_SAP, MOVE_PSYCHIC, MOVE_HEX, MOVE_AIR_SLASH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .ability = ABILITY_AFTERMATH,
    .moves = {MOVE_FLAMETHROWER, MOVE_PLAY_ROUGH, MOVE_CRUNCH, MOVE_BODY_SLAM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_ROCKY_HELMET,
    .ability = ABILITY_ROUGH_SKIN,
    .moves = {MOVE_OUTRAGE, MOVE_SUCKER_PUNCH, MOVE_SCALE_SHOT, MOVE_ROCK_SLIDE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_SHADOW_TAG,
    .moves = {MOVE_MIRROR_COAT, MOVE_COUNTER, MOVE_DESTINY_BOND},
    },
};
static const struct TrainerMon sParty_RocketHideoutB1_Giovanni_Three[] = {
       {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    .species = SPECIES_NIDOKING,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .ability = ABILITY_TECHNICIAN,
    .moves = {MOVE_PLAY_ROUGH, MOVE_SHADOW_CLAW, MOVE_FACADE, MOVE_U_TURN},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM, MOVE_BREAKING_SWIPE, MOVE_MEGAHORN},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 75,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_INTIMIDATE,
    .moves = {MOVE_RAGING_BULL, MOVE_ENDEAVOR, MOVE_ZEN_HEADBUTT, MOVE_STOMPING_TANTRUM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 76,
    ...
    .moves = {MOVE_SUCKER_PUNCH, MOVE_EARTHQUAKE, MOVE_TRI_ATTACK, MOVE_STONE_EDGE},
    }, 
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 78,
    ...
    .moves = {MOVE_FOCUS_BLAST, MOVE_PSYSTRIKE, MOVE_ICE_BEAM, MOVE_FIRE_BLAST},
    }
};
static const struct TrainerMon sParty_MewtwoIsland_One[] = {
       {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_NIDOKING,
    ...
    .moves = {MOVE_SUCKER_PUNCH, MOVE_CRUNCH, MOVE_HAMMER_ARM, MOVE_IRON_TAIL}
    }
};
static const struct TrainerMon sParty_MewtwoIsland_Two[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_CRADILY,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = ABILITY_STORM_DRAIN,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_ANCIENT_POWER, MOVE_LEECH_SEED},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_BRAVE_BIRD, MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_ICY_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .ability = ABILITY_LEVITATE,
    .moves = {MOVE_EARTH_POWER, MOVE_HEAT_WAVE, MOVE_DRAGON_PULSE, MOVE_U_TURN},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_PSYCHIC_FANGS, MOVE_BULLET_PUNCH, MOVE_METEOR_MASH},
    }
};
static const struct TrainerMon sParty_MewtwoIsland_Three[] = {
        {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_TORKOAL,
    .ability = ABILITY_DROUGHT,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_HEAT_WAVE, MOVE_ERUPTION, MOVE_SOLAR_BEAM, MOVE_YAWN},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_CHOICE_SPECS,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_POWER_GEM, MOVE_MOONBLAST, MOVE_ICY_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_VENUSAUR,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_SLUDGE_BOMB, MOVE_GROWTH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .moves = {MOVE_SNARL, MOVE_EXTREME_SPEED, MOVE_SACRED_FIRE, MOVE_STOMPING_TANTRUM},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_BOOSTER_ENERGY,
    .moves = {MOVE_PRECIPICE_BLADES, MOVE_SWORDS_DANCE, MOVE_HEAT_CRASH, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
...
static const struct TrainerMon sParty_MewtwoIsland_Four[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_ETERNATUS,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_DYNAMAX_CANNON, MOVE_RECOVER, MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_FLASH_FIRE,
    .moves = {MOVE_ERUPTION, MOVE_MAGMA_STORM, MOVE_EARTH_POWER, MOVE_HEAT_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_ELECTRIC_SURGE,
    .moves = {MOVE_DRAGON_ASCENT, MOVE_EXTREME_SPEED, MOVE_SWORDS_DANCE, MOVE_CRUNCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_LUNAR_BLESSING, MOVE_MOONBLAST, MOVE_ALLY_SWITCH},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_FOCUS_SASH,
    .moves = {MOVE_DARK_VOID, MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_ICY_WIND},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .moves = {MOVE_LUSTER_PURGE, MOVE_DRACO_METEOR, MOVE_ENERGY_BALL, MOVE_AIR_SLASH},
    },
};
static const struct TrainerMon sParty_MewtwoIsland_Five[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_KYOGRE,
    ...
    .heldItem = ITEM_COVERT_CLOAK,
    .ability = ABILITY_PRANKSTER,
    .moves = {MOVE_RAIN_DANCE, MOVE_TAILWIND, MOVE_BLEAKWIND_STORM, MOVE_TAUNT},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    .species = SPECIES_ZAPDOS,
    .heldItem = ITEM_ROCKY_HELMET,
    .moves = {MOVE_THUNDER, MOVE_HEAT_WAVE, MOVE_ROOST, MOVE_THUNDER_WAVE},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_HURRICANE, MOVE_WIDE_GUARD, MOVE_ROOST, MOVE_WEATHER_BALL},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
...
static const struct TrainerMon sParty_MewtwoIsland_Six[] = {
       {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 90,
    .species = SPECIES_PIKACHU,
    ...
    .moves = {MOVE_VOLT_TACKLE, MOVE_QUICK_ATTACK, MOVE_NUZZLE, MOVE_ENDEAVOR}
    },
    ...
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = ABILITY_THICK_FAT,
    .moves = {MOVE_HEAVY_SLAM, MOVE_HEAT_CRASH, MOVE_BODY_SLAM, MOVE_REST},
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
    ...
    .heldItem = ITEM_CHARIZARDITE_Y,
    .moves = {MOVE_FIRE_BLAST, MOVE_HEAT_WAVE, MOVE_ROOST, MOVE_SOLAR_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 85,
...
static const struct TrainerMon sParty_MewtwoIsland_Seven[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 90,
    .species = SPECIES_MEWTWO,
    .heldItem = ITEM_LIFE_ORB,
    .ability = ABILITY_UNNERVE,
    .moves = {MOVE_FOCUS_BLAST, MOVE_PSYSTRIKE, MOVE_DARK_PULSE, MOVE_EARTH_POWER},
    },
        {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 90,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_PSYCHO_CUT, MOVE_DRAIN_PUNCH, MOVE_BULK_UP, MOVE_FIRE_PUNCH},
    },
        {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 90,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_PSYSTRIKE, MOVE_ICE_BEAM, MOVE_FIRE_BLAST},
    },
};